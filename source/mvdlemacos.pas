...
{
https://forum.lazarus.freepascal.org/index.php?topic=43041.0
...
type
  ...
  TMvDEMacOS = class(TMvCustomDownloadEngine)
  private
    {
...
procedure TMvDEMacOS.InternalDownloadFile(const Url: string; AStream: TStream);
var
